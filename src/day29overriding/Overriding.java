...
public class Overriding {
	...
	/*
	 1) Parent Class daki bir methodu Child Class a gore 
	 	...
	 	yapabilirsiniz.
	 2) a)Overriding yaparken "method signature (name+parametre)" a
	      dokunulmaz.
	    b)Overriding yaparken "acces modifier" lar belli kurallara 
	      gore degistirlebilir.
	    c)Overriding yaparken "return type" lar belli kurallara gore 
	      degistirilebilir.
	    d)Overriding yaparken "method body" degistirilir zaten "Overriding"
	      in amaci budur. Ama method body yi degistirmeden kullanirsaniz
	      Java CTE vermez. Ama Overriding de method body i 
	    ...
	    f)Override edilen method parenttaki methoddur ve Java da o methoda 
	    ...
	    3)Overriding methodun basina "@Override" annotation ini koyarsaniz
	      Java yaptiginiz overriding i kontrol eder,herhangi bir yanlişlik varsa CTE verir.
	    4)"Overriding Method" un access modifier , ya "Overridden Method" ile ayni olur
	       ya da daha genis olur.
	    5)Return type’lar primitive ise “Overriding Method” un return type’i 
	 	...
	 	12)"Polymorphism" nedir?"--->interview sorusu
